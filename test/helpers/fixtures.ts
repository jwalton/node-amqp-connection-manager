...
import {AmqpConnectionOptions, CreateChannelOptions, IAmqpConnectionManager} from "../../src/decorate";

export class FakeAmqp {
    public connection: FakeConnection | undefined;
    ...
    reset() {
        ...
        this.connect = jest.fn().mockImplementation((url) => {
            ...
            const connection = (this.connection = new FakeConnection(url));
...
export class FakeAmqpConnectionManager extends EventEmitter implements IAmqpConnectionManager {
    ...
    simulateConnect() {
        ...
        this._connection = new FakeConnection(url);
        this.connected = true;
        this.emit('connect', {
